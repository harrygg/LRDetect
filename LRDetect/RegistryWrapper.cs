...
namespace LRDetect
{
    ...
    public static class RegistryWrapper
    {
        ...
        /// <returns></returns>
        public static string GetValue(UIntPtr inHive, string registryPath, string keyName)
        {
            string value = String.Empty;
            try
            {
                //first we'll check the 64bit registry - 
                value = RegistryWrapper.GetRegKey64(inHive, registryPath, keyName);
                if (value == null)
                {
        ...
        public static List<string> GetValueNames(UIntPtr inHive, String inKeyName)
        {
            ...
            if (valueNames == null)
                valueNames = GetValueNames(inHive, inKeyName, RegSAM.WOW64_32Key);
            return valueNames;
        }
        /// <summary>
